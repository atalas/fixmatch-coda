...
class ModelData:
	...
	# X_augmented:  np.ndarray # augmented unlabeled matrix
...
def TrainingLoop(md):
	...
	# X & y references keep augmentation functions generic
	md.y = md.y_unlabeled = pseudo_labels
	md.X = md.X_unlabeled
	...
	for loop in range(md.totalLoops):
		...
		# Predict on augmented unlabeled data
